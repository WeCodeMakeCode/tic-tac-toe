namespace SpriteKind {
    ...
    export const place_say = SpriteKind.create()
}
...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    if (b_choosing_game_type) {
        ...
        clean_up_from_prior_game()
        display_messages("", 4, 7)
        display_messages("PICK GAME TYPE <--", 4, 7)
    }
})
...
function make_images_and_place_sprites () {
    Empty_image = img`
. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 
. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 
. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 
...
`
    ...
    for (let I = 0; I <= 2; I++) {
        ...
        for (let J = 0; J <= 2; J++) {
            ...
            Place.image.fill(0)
            Place.z = 1
            pss = sprites.create(image.create(1, 1), SpriteKind.place_say)
            pss.y = Place.y + 20
            pss.x = Place.x - 0
            pss.z = Place.x + 12
            L += 40
    ...
    place_say_array = sprites.allOfKind(SpriteKind.place_say)
}
...
function count_fuLl_positions () {
    Count = 0
    for (let value of status_array) {
        if (value != BLANK) {
            Count += 1
        }
    }
...
function clean_up_from_prior_game () {
    ...
    for (let value of place_say_array) {
        value.say("")
    }
}
...
function mark_choice (Player: number, choice: number) {
    ...
    if (b_show_move_number) {
        place_say_array[choice].say("" + (count_fuLl_positions() - 1))
    }
}
...
let COMPUTER = 0
let HUMAN = 0
let b_show_move_number = false
let ms_delay_between_moves = 0
b_show_move_number = false
HUMAN = 0
COMPUTER = 1
BLANK = 2
Next_player = BLANK
